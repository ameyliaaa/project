    ...
    <div class="card card-info">
      ...
      <?php if($_GET['notif']=="tambahpenerbitkosong"){?>
      <div class="alert alert-danger" role="alert">
      Maaf data penerbit wajib di isi</div>
      <?php }?>
      <?php if($_GET['notif']=="tambahalamatkosong"){?>
      <div class="alert alert-danger" role="alert">
      Maaf alamat wajib di isi</div>
      <?php }?>
      <?php }?>
      
      <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-tambah-penerbit" enctype="multipart/form-data">
        <div class="card-body">
