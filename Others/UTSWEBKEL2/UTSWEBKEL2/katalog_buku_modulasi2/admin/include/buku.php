            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="index.php?include=tambah-buku" 
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      $sql_jum = "SELECT `b`.`id_buku`, `b`.`judul`, `k`.`kategori_buku`, `p`.`penerbit` 
                                  FROM `buku` `b` JOIN `kategori_buku` `k` ON `b`.`id_kategori_buku` =  `k`.`id_kategori_buku` 
                                  JOIN `penerbit` `p` ON `b`.`id_penerbit` = `p`.`id_penerbit`"; 
                      if (!empty($katakunci_buku)){
                        $sql_jum .= " WHERE `b`.`judul` LIKE '%$katakunci_buku%' OR `k`.`kategori_buku` LIKE '%$katakunci_buku%' OR `p`.`penerbit` LIKE '%$katakunci_buku%'";
                      } 
                    ...
                    if(!isset($_GET['halaman'])){
                      ...
                      $sql_b = "SELECT `b`.`id_buku`, `b`.`Judul`, `k`.`kategori_buku`, `p`.`penerbit` 
                      ...
                      ?>
                        <tr>
                          ...
                          window.location.href ='index.php?include=buku&aksi=hapus&data=<?php echo 
                          $id_buku;?>&notif=hapusberhasil'"
