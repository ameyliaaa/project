          ...
          <form class="form-horizontal" method="POST" action="index.php?include=konfirmasi-ubah-password">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <input type="password" class="form-control" name="pwlama" id="pass_lama" value="">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <input type="password" class="form-control" name="pwbaru" id="pass_baru" value="">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <input type="password" class="form-control" name="konfirmasipwbaru" id="konfirmasi" value="">
