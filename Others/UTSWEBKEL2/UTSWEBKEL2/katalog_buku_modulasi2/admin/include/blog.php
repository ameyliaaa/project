...
if(isset($_POST["katakunci_blog"])){
  $katakunci_blog = $_POST["katakunci_blog"];
...
?>
    ...
    <section class="content">
            <div class="card">
              ...
              if (!empty($katakunci_blog)){
                $sql_jum .= " WHERE `b`.`judul` LIKE '%$katakunci_blog%' OR `k`.`kategori_blog` LIKE '%$katakunci_blog%' OR `b`.`tanggal` LIKE '%$katakunci_blog%'";
                } 
