...
?>
    ...
    <section class="content">
            <div class="card">
              ...
              <div class="col-sm-12">
                ...
                <?php if($_GET['notif']=="tambahpenerbitberhasil"){?>
  ...
  <tbody>
    ...
    <tr>
       ...
       <a href="index.php?include=detail-penerbit&data=<?php echo $id_penerbit;?>" class="btn btn-xs btn-info" name="detail" value="detail" title="Detail"><i class="fas fa-eye"></i> Detail</a>
       <a href="javascript:if(confirm('Anda yakin ingin menghapus data 
       <?php echo $penerbit; ?>?'))window.location.href = 'index.php?include=penerbit&aksi=hapus&data=<?php echo $id_penerbit;?>&notif=hapusberhasil'" 
...
<?php 
    if($jum_halaman==0){
       ...
       if($halaman!=1){
        ...
        if ($i > $halaman - 2 and $i < $halaman + 2 ) {
          if($i!=$halaman){
