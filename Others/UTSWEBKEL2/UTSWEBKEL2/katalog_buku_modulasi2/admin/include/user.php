...
if(isset($_POST["katakunci"])){
  ...
  $_SESSION['katakunci_up'] = $katakunci_up;
}
if(isset($_SESSION['katakunci_up'])){
  $katakunci_up = $_SESSION['katakunci_up'];
}
?>
    ...
    <section class="content">
          ...
          <tbody>
            ...
            <?php $no++;}?>
              ...
              if (!empty($katakunci_up)){
                $sql_jum .= " where `nama` LIKE '%$katakunci_up%' OR `email` LIKE '%$katakunci_up%' OR `level` LIKE '%$katakunci_up%'";
                } 
